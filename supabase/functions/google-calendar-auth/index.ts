...
serve(async (req) => {
  ...
  try {
    let requestData;
    // Handle Google OAuth callback as GET - This shouldn't be needed as we handle callback through UI route
...
// All the helper functions below should be kept intact
