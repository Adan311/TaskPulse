 ...
 * Following MCP pattern with user authentication and validation
 */
 ...
 * Following MCP pattern with user-based filtering
 */
 ...
 * Following MCP pattern with user ownership validation
 */
